...
CREATE TABLE `anomaly` (
  ...
  `summary` longtext CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
  `description` longtext CHARACTER SET latin1 COLLATE latin1_swedish_ci,
  `repairsteps` longtext CHARACTER SET latin1 COLLATE latin1_swedish_ci,
...
CREATE TABLE `attachment` (
  ...
  `anomalyid` int NOT NULL,
  `storage` longtext CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
...
-- Dump completed on 2023-06-15 11:44:57
